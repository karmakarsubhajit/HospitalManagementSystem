...
$sql= "call update_doctor('$doctorID','$doctorName', '$doctorDOB', '$doctorGender', '$doctorSpecialization', '$doctorYears_Of_Experience', '$doctorAddress' , '$doctorEmail', '$doctorContactno' )";


$ans = $conn->query($sql);
if($ans)
{
    echo "<h2>Doctor update succesfully! </h2> ";
}
else{
    echo "<h2> Oops Doctor couldn't be updated! </h2>" ; 
}
?> 
