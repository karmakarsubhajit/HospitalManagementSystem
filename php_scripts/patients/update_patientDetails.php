...
$sql= "call update_patient ('$patientID', '$patientName', '$patientDOB', '$patientGender', '$patientAddress' ,  '$patientEmail', '$patientContactno', '$patientMedicalHistory')  " ;


$ans = $conn->query($sql);
if($ans)
{
    echo "<h2>Patient updated succesfully! </h2> ";
}
else{
    echo "<h2> Oops Patient couldn't be updated! </h2>" ; 
}
?> 
